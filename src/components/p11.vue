<template>
  <div class="p2">
    ...
    <!-- 中间 -->
    <div class="main">
      <div class="mainbg"><img src="../assets/p2/41-8.png" alt=""></div>
      <div class="main2"><img src="../assets/p2/42-8.png" alt=""></div>
      <div class="main4">
        <div class="main4zi">相守是一种承诺，愿你拥有一份温柔的情谊</div>
      </div>
    </div>
    <div class="main1">集美貌与才华一身的你，身体里肯定隐藏了满满的运动基因！</div>
    <div class="main3"></div>
    ...
    <div class="anniu">
        <!-- <img src="../assets/p2/p2-24.png" alt> -->
      </div>
  </div>
</template>
...
.main {
  width: 12rem;
  height: 21rem;
  /* background: url('../assets/p2/41-8.png') no-repeat; */
  background-size: 100%;
  position: absolute;
  left: 52%;
  top: 50%;
...
.main2 {
    width: 18rem;
    height: 12rem;
    /* background: url(../assets/p2/42-8.png) no-repeat; */
    background-size: 100%;
    position: absolute;
    top: 28%;
    left: -24%;
...
.main3 {
  width: 4.2rem;
  height: 13.8rem;
  background: url('../assets/p2/38-8.png') no-repeat;
  background-size: 100%;
  position: absolute;
  right: 7%;
  top: 6%;
